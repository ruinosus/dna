...
_COVERED: dict[tuple[str, str], str] = {
    ...
    ("GET", "/v1/definitions/{kind}/{name}/reconcile"): "reconcile_forks",
    ...
    ("PUT", "/v1/definitions/{kind}/{name}/entries/{entry}"): "write_bundle_entry",
    ("DELETE", "/v1/definitions/{kind}/{name}/entries/{entry}"): "revert_bundle_entry",
    ...
    ("POST", "/v1/memories/{name}/forget"): "forget_memory",
    ("POST", "/v1/memories/{name}/revive"): "revive_memory",
