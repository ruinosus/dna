...
class TestSkillResolution:
    def test_resolves_specific_skills(self, tmp_path):
        ...
        skills = [d for d in mi.instances if d.kind == "Skill"]
    ...
    def test_skill_instruction_not_empty(self, tmp_path):
        ...
        skill = next((d for d in mi.instances if d.kind == "Skill" and d.name == "brainstorming"), None)
...
class TestSoulResolution:
    def test_resolves_soul(self, tmp_path):
        ...
        souls = [d for d in mi.instances if d.kind == "Soul"]
    ...
    def test_soul_has_content(self, tmp_path):
        ...
        soul = next((d for d in mi.instances if d.kind == "Soul" and d.name == "brad"), None)
...
class TestGuardrailResolution:
    ...
    def test_resolves_guardrail(self, tmp_path):
        ...
        guardrails = [d for d in mi.instances if d.kind == "Guardrail"]
    ...
    def test_guardrail_has_rules(self, tmp_path):
        ...
        gr = next((d for d in mi.instances if d.kind == "Guardrail" and d.name == "pii-shield"), None)
...
class TestAllKindsTogether:
    ...
    def test_all_three_kinds_resolve(self, tmp_path):
        ...
        assert next((d for d in mi.instances if d.kind == "Skill" and d.name == "my-skill"), None) is not None
        assert next((d for d in mi.instances if d.kind == "Soul" and d.name == "wise"), None) is not None
        assert next((d for d in mi.instances if d.kind == "Guardrail" and d.name == "safe"), None) is not None
    ...
    def test_cache_roundtrip_all_kinds(self, tmp_path):
        ...
        assert next((d for d in mi1.instances if d.kind == "Skill" and d.name == "my-skill"), None) is not None
        assert next((d for d in mi1.instances if d.kind == "Soul" and d.name == "wise"), None) is not None
        assert next((d for d in mi1.instances if d.kind == "Guardrail" and d.name == "safe"), None) is not None
        ...
        assert next((d for d in mi2.instances if d.kind == "Skill" and d.name == "my-skill"), None) is not None
        assert next((d for d in mi2.instances if d.kind == "Soul" and d.name == "wise"), None) is not None
        assert next((d for d in mi2.instances if d.kind == "Guardrail" and d.name == "safe"), None) is not None
