...
class KindBase:
    ...
    # ``True`` only on Kinds whose instances are generated by runtime
    ...
    #   "record" — pure typed instance (Story, EvalRun, WorkflowEvent, ...);
    ...
    # ``scope_inheritable``: instances of this Kind inherit across scopes by
    ...
    # was a hardcoded ``kind == "Genome"`` check in write_instance). True
    ...
    def get_default_agent_name(self, doc: Any) -> str | None:
        """Which agent (Agent) owns instances of this Kind."""
        del doc
        return None
