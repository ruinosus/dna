...
``dna.kernel.layer_resolver``. This module reexports the old
...
from dna.kernel.layer_resolver import (  # noqa: F401
...
warnings.warn(
    ...
    "DefaultLayerResolver/deep_merge from dna.kernel.layer_resolver "
