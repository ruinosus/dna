...
# ---------------------------------------------------------------------------
# Narrative — moved to dna_cli/sdlc/narrative.py (sdlc_cmd decomposition).
# ---------------------------------------------------------------------------

from dna_cli.sdlc.narrative import (  # noqa: E402, F401 — re-exported for back-compat
    _append_to_narrative_array,
    cmd_narrative_add_decision,
    cmd_narrative_add_open_item,
    cmd_narrative_add_paragraph,
    cmd_narrative_new,
    cmd_narrative_status,
    narrative_group,
)
...
# ---------------------------------------------------------------------------
# Initiative — moved to dna_cli/sdlc/initiative.py (sdlc_cmd decomposition).
# ---------------------------------------------------------------------------

from dna_cli.sdlc.initiative import (  # noqa: E402, F401 — re-exported for back-compat
    VALID_INITIATIVE_STATUS,
    cmd_initiative_cancel,
