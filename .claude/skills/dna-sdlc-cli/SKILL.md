...
dna sdlc story create s-my-work \
  ...
  --priority high --labels cli,docs --reporter claude-code \
...
- Editing the **schema** of an SDLC Kind (that's SDK code, both languages —
  not the CLI).
